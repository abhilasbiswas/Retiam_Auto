...
closest.mat.metallic = mesh.mat2.w; // <- NEW
    ...
    return vec4<f32>(pow(color, vec3<f32>(1.0 / 2.2)), 1.0); 
        ...
        return {
            ...
            /* Extracted ReplacementTransform */
            ...
            /* Extracted TransformMatchingShapes */
...
/* Extracted Group */
            ...
            /* Extracted MeshObject */



            /* Extracted TaichiWater */
            ...
            // ==========================================
            /* Extracted CornellBoxScene */



            /* Extracted NativeWaterScene */
